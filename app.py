...
st.set_page_config(page_title='Green Coffee in Canada', page_icon='☕️', layout='wide', initial_sidebar_state='expanded')

pages = [st.Page('pages/about_page.py',title='About the Home Greens Project Canada',default=True), 
